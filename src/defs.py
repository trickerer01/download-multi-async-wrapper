...
DOWNLOADERS = [
    DOWNLOADER_NM, DOWNLOADER_RV, DOWNLOADER_RC, DOWNLOADER_RN, DOWNLOADER_RX, DOWNLOADER_RS, DOWNLOADER_RP, DOWNLOADER_EN, DOWNLOADER_XB
]
RUXX_DOWNLOADERS = (DOWNLOADER_RN, DOWNLOADER_RX, DOWNLOADER_RS, DOWNLOADER_RP, DOWNLOADER_EN, DOWNLOADER_XB)
...
RANGE_ID_TEMPLATE_RX_RS_XB = StrPair(('id:>=%d', ' id:<=%d'))
...
RANGE_TEMPLATE_IDS = {
    ...
    DOWNLOADER_RX: RANGE_ID_TEMPLATE_RX_RS_XB,
    DOWNLOADER_RS: RANGE_ID_TEMPLATE_RX_RS_XB,
    DOWNLOADER_RP: RANGE_ID_TEMPLATE_RN_RP,
    DOWNLOADER_EN: RANGE_ID_TEMPLATE_EN,
    DOWNLOADER_XB: RANGE_ID_TEMPLATE_RX_RS_XB,
}
