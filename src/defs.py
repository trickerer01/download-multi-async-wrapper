...
PATH_APPEND_DOWNLOAD_IDS_NM = DOWNLOADER_NM
PATH_APPEND_DOWNLOAD_IDS_RV = DOWNLOADER_RV
PATH_APPEND_DOWNLOAD_IDS_RC = DOWNLOADER_RC
PATH_APPEND_DOWNLOAD_IDS_RG = DOWNLOADER_RG
PATH_APPEND_DOWNLOAD_PAGES_NM = DOWNLOADER_NM
PATH_APPEND_DOWNLOAD_PAGES_RV = DOWNLOADER_RV
PATH_APPEND_DOWNLOAD_PAGES_RC = DOWNLOADER_RC
PATH_APPEND_DOWNLOAD_PAGES_RG = DOWNLOADER_RG
PATH_APPEND_UPDATE_RUXX = 'src/ruxx_cmd.py'
PATH_APPEND_UPDATE_NM = DOWNLOADER_NM
PATH_APPEND_UPDATE_RV = DOWNLOADER_RV
PATH_APPEND_UPDATE_RC = DOWNLOADER_RC
PATH_APPEND_UPDATE_RG = DOWNLOADER_RG
