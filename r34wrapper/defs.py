...
PATH_APPEND_DOWNLOAD_RUXX = MODULE_RUXX
PATH_APPEND_DOWNLOAD_IDS_NM = MODULE_NM
PATH_APPEND_DOWNLOAD_IDS_RV = MODULE_RV
PATH_APPEND_DOWNLOAD_IDS_RC = MODULE_RC
PATH_APPEND_DOWNLOAD_IDS_RG = MODULE_RG
PATH_APPEND_DOWNLOAD_PAGES_NM = MODULE_NM
PATH_APPEND_DOWNLOAD_PAGES_RV = MODULE_RV
PATH_APPEND_DOWNLOAD_PAGES_RC = MODULE_RC
PATH_APPEND_DOWNLOAD_PAGES_RG = MODULE_RG
PATH_APPEND_UPDATE_RUXX = MODULE_RUXX
PATH_APPEND_UPDATE_NM = MODULE_NM
PATH_APPEND_UPDATE_RV = MODULE_RV
PATH_APPEND_UPDATE_RC = MODULE_RC
PATH_APPEND_UPDATE_RG = MODULE_RG
PATH_APPEND_REQUIREMENTS = 'requirements.txt'

PATH_APPEND_DOWNLOAD_IDS: dict[str, str] = {
    DOWNLOADER_NM: PATH_APPEND_DOWNLOAD_IDS_NM,
    DOWNLOADER_RV: PATH_APPEND_DOWNLOAD_IDS_RV,
    DOWNLOADER_RC: PATH_APPEND_DOWNLOAD_IDS_RC,
    DOWNLOADER_RG: PATH_APPEND_DOWNLOAD_IDS_RG,
...
PATH_APPEND_DOWNLOAD_PAGES: dict[str, str] = {
    DOWNLOADER_NM: PATH_APPEND_DOWNLOAD_PAGES_NM,
    DOWNLOADER_RV: PATH_APPEND_DOWNLOAD_PAGES_RV,
    DOWNLOADER_RC: PATH_APPEND_DOWNLOAD_PAGES_RC,
    DOWNLOADER_RG: PATH_APPEND_DOWNLOAD_PAGES_RG,
    DOWNLOADER_RN: PATH_APPEND_DOWNLOAD_RUXX,
    DOWNLOADER_RX: PATH_APPEND_DOWNLOAD_RUXX,
    DOWNLOADER_RS: PATH_APPEND_DOWNLOAD_RUXX,
    DOWNLOADER_RP: PATH_APPEND_DOWNLOAD_RUXX,
...
PATH_APPEND_UPDATE: dict[str, str] = {
    ...
    DOWNLOADER_RG: PATH_APPEND_UPDATE_RG,
